            ...
            onPressed: () {
              ...
              gotoCurrentLocation().then((value) async {
                ...
                List<Placemark> address = await placemarkFromCoordinates(
                    ...
                    double.parse(Plong.toString()));

                var country = address.last.country.toString();
                var city = address.last.subAdministrativeArea.toString();
                await fireStore
                    .collection('users')
                    .doc(currentController.currentUser?.uid)
                    .update({'Location': '$country , $city'});

                
                // Get.offAndToNamed(Paths.user_Setting);
